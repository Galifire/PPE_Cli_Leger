@include('header')
    ...
    <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#newClient">
...
@foreach ($clients as $c)
    <tr>
        ...
        <td>{{$c->Telephone}}</td>
        <td>
            <a href={{route('clientEdit', $c->CLINum)}}>
            ...
            <button class="btn btn-outline-danger" data-toggle="modal" data-target="#deleteClient">
            ...
            <div class="modal fade" id="deleteClient" tabindex="-1" role="dialog" aria-labelledby="deleteClient" aria-hidden="true">
