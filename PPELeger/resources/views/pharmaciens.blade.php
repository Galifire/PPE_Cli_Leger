                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Mettre à jour le pharmacien {{$p->PHNum}}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                            <div class="modal-body">
                                <label>PHNum : </label>
                                <input value={{$p->PHNum}} disabled><br><br>

                                <label>Nom : </label>
                                <input value={{$p->Nom}}><br><br>

                                <label>Prénom : </label>
                                <input value={{$p->Prenom}}><br><br>

                                <label>Email : </label>
                                <input value={{$p->Email}}><br><br>

                                <label>Téléphone : </label>
                                <input value={{$p->Telephone}}><br><br>
                            </div>
