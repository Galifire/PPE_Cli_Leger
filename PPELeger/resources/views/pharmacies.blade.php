...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th scope="col">Détails/Editer/Supprimer</th>
        </tr>
    </thead>
    <tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Mettre à jour la pharmacie {{$p->PHARCode}}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                            <div class="modal-body">
                                <label>Code de la Pharmacie : </label>
                                <input value={{$p->PHARCode}} disabled><br><br>

                                <label>Adresse : </label>
                                <input value={{$p->Adresse}}><br><br>

                                <label>Ville : </label>
                                <input value={{$p->Ville}}><br><br>

                                <label>Effectif : </label>
                                <input value={{$p->Effectif}}><br><br>
                            </div>
