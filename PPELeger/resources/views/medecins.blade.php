                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Mettre à jour le médecin {{$m->MEDNum}}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                            <div class="modal-body">
                                <label>Numéro du Médecin : </label>
                                <input value={{$m->MEDNum}} disabled><br><br>

                                <label>Nom : </label>
                                <input value={{$m->Nom}}><br><br>

                                <label>Prénom : </label>
                                <input value={{$m->Prenom}}><br><br>

                                <label>Adresse : </label>
                                <input value={{$m->Adresse}}><br><br>

                                <label>Email : </label>
                                <input value={{$m->Email}}><br><br>
                            </div>
