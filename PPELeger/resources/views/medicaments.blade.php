                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Mettre à jour le médicament {{$m->MEDICCode}}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                            <div class="modal-body">
                                <label>Code du Médicament : </label>
                                <input value={{$m->MEDICCode}} disabled><br><br>

                                <label>Nom : </label>
                                <input value={{$m->Nom}}><br><br>

                                <label>Restrictions : </label>
                                <input value={{$m->Restrictions}}><br><br>

                                <label>Caractéristiques : </label>
                                <input value={{$m->Caracteristiques}}><br><br>

                                <label>Délai de production : </label>
                                <input value={{$m->DelaiProduction}}><br><br>
                            </div>
