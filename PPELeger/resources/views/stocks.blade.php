                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Mettre à jour les stocks {{$s->STORef}}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                            <div class="modal-body">
                                <label>Code de la Pharmacie : </label>
                                <input value={{$s->PHARCode}}><br><br>

                                <label>Code du Médicament : </label>
                                <input value={{$s->MEDICCode}}><br><br>

                                <label>Quantité : </label>
                                <input value={{$s->Qte}}><br><br>
                            </div>
