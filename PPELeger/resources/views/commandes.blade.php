                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Mettre à jour la Commande {{$c->CDERef}}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                            <div class="modal-body">
                                <label>Code du Médicament : </label>
                                <input value={{$c->MEDICCode}}><br><br>

                                <label>Numéro du Médecin : </label>
                                <input value={{$c->MEDNum}}><br><br>

                                <label>Numéro du Client : </label>
                                <input value={{$c->CLINum}}><br><br>

                                <label>Date de la commande : </label>
                                <input value={{$c->DateCde}}><br><br>

                                <label>Quantité : </label>
                                <input value={{$c->Qte}}><br><br>
                            </div>
